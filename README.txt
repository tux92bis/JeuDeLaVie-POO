...
## Description
Ce projet implémente le célèbre **Jeu de la Vie** de John Conway en C++, avec deux modes d'exécution :
...
- **Bibliothèque SFML** : Installez SFML en exécutant :
  ```bash
  sudo apt install libsfml-dev (pour une distribution linux ayant comme base Debian)
